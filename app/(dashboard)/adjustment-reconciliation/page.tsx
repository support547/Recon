...
import { AdjustmentReconciliationClient } from "@/components/adjustment-reconciliation/adjustment-reconciliation-client";
...
export default function AdjustmentReconciliationPage() {
  return (
    <Suspense
      fallback={
    ...
    >
      <AdjustmentReconciliationLoader />
    </Suspense>
  );
}
