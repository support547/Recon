...
import { saveReturnCaseAction } from "@/actions/returns-reconciliation";
...
const REASON_OPTIONS = [
  ...
  "Customer returned different FNSKU",
  "FNSKU mismatch — potential fraud",
  "Order not found in sales data",
  "Missing return credit",
...
export function RaiseCaseModal({
  ...
  async function onSubmit() {
    ...
    setBusy(true);
    try {
      const res = await saveReturnCaseAction({
        orderId: row.orderId,
        msku: row.msku,
