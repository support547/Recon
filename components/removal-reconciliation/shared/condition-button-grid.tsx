...
export const CONDITION_PRESETS: ConditionPreset[] = [
  ...
  { value: "USED ACCEPTABLE", label: "USED ACCEPTABLE", icon: "📗", transferTo: "FBA Reshipment", whStatus: "Received - Ready",         triggersCase: false },
  { value: "WRONG ITEM",      label: "WRONG ITEM",      icon: "❌", transferTo: "Hold / Pending", whStatus: "Incorrect Item",           triggersCase: true,  caseReason: "Removal_Incorrect_Item" },
