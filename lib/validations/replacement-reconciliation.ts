...
export const raiseReplaceCaseSchema = z.object({
...
export type RaiseReplaceCaseInputZ = z.infer<typeof raiseReplaceCaseSchema>;

export const replaceAdjustmentSchema = z.object({
  orderId: z.string().min(1),
  msku: z.string().min(1),
  asin: optStr,
...
export type ReplaceAdjustmentInputZ = z.infer<typeof replaceAdjustmentSchema>;
